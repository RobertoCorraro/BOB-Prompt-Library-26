        ...
        <header className="sticky top-0 z-50 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 transition-colors duration-200">
            <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between gap-4">
                <div className="flex items-center gap-2">
                    ...
                    {/* La versione non compare qui: è mostrata una sola volta
                        da VersionBadge, che la legge da package.json. */}
                    <h1 className="hidden sm:block text-xl font-bold leading-none bg-clip-text text-transparent bg-gradient-to-r from-violet-600 to-purple-600 dark:from-violet-400 dark:to-purple-400">
                        BOB Prompt Library
                    </h1>
                </div>
                ...
                <div className="flex items-center gap-1 sm:gap-2">
                    ...
                    <button
                        ...
                        className={`p-1.5 sm:p-2 rounded-xl flex flex-col items-center gap-0.5 transition-all ${
                            ...
                            : 'text-slate-500 hover:text-rose-500 hover:bg-slate-100 dark:text-slate-500 dark:hover:bg-slate-800'
                        }`}
                    ...
                    <button
                        onClick={toggleTheme}
                        className="p-1.5 sm:p-2 text-slate-500 hover:text-violet-600 dark:text-slate-500 dark:hover:text-violet-400 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-xl flex flex-col items-center gap-0.5 transition-all"
                    ...
                    {isLoggedIn && (
                        <button
                            ...
                            className="p-1.5 sm:p-2 text-slate-500 hover:text-purple-600 dark:text-slate-500 dark:hover:text-purple-400 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-xl flex flex-col items-center gap-0.5 transition-all"
                    ...
                    {isLoggedIn ? (
                        <button
                            ...
                            className="p-1.5 sm:p-2 text-slate-500 hover:text-red-500 dark:text-slate-500 dark:hover:text-red-400 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-xl flex flex-col items-center gap-0.5 transition-all"
                            title="Esci"
                        >
                        ...
                        <button
                            ...
                            className="p-1.5 sm:p-2 text-slate-500 hover:text-emerald-500 dark:text-slate-500 dark:hover:text-emerald-400 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-xl flex flex-col items-center gap-0.5 transition-all"
                            title="Accedi"
                        >
