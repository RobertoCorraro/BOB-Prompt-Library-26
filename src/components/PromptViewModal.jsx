    ...
    return (
        <div className="fixed inset-0 z-[110] bg-slate-900/60 backdrop-blur-md flex items-center justify-center p-4 animate-in fade-in duration-300">
            ...
            >
                ...
                {/* Footer Actions */}
                <div className="p-5 bg-slate-50 dark:bg-slate-900/50 border-t border-slate-100 dark:border-slate-700 space-y-4">
                    {/* Primary Actions Grid */}
                    <div className="grid grid-cols-2 gap-3">
                        <button
                            onClick={handleCopy}
                            className={`flex items-center justify-center gap-2 font-bold py-3.5 px-4 rounded-2xl transition-all shadow-sm active:scale-95 ${copied
                    ...
                    <div id="popup__azioni_secondarie" className="grid grid-cols-2 gap-3">
                        <button
                        ...
                        <button
                            ...
                            className="flex items-center justify-center gap-2 py-3 px-3 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-red-500/70 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-900/10 text-xs font-bold transition-all active:scale-95"
                        >
